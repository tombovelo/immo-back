...
public class TypeTransactionService {
    ...
    public TypeTransaction update(Long id, TypeTransaction typeTransaction) {
        TypeTransaction existing = repository.findById(id)
    ...
    public void delete(Long id) {
        TypeTransaction typeTransaction  = repository.findById(id)
